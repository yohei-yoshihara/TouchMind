...
COM_DECLSPEC_NOTHROW HRESULT touchmind::animation::AnimationManagerEventHandler::CreateInstance(
    IAnimationStatusChangedListener *pListener, IUIAnimationManagerEventHandler **ppManagerEventHandler) {
...
HRESULT
touchmind::animation::AnimationManagerEventHandler::OnManagerStatusChanged(UI_ANIMATION_MANAGER_STATUS newStatus,
