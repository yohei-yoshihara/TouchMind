...
void touchmind::operation::NodeMovingOperation::Draw(touchmind::Context *pContext, ID2D1RenderTarget *pRenderTarget,
  ...
  util::CoordinateConversion::ConvertScreenToModelCoordinate(m_hwnd, m_pScrollBarHelper, cursorPoint,
                                                             &clientCursorPoint);
  ...
  pRenderTarget->PushLayer(D2D1::LayerParameters(D2D1::InfiniteRect(), nullptr, D2D1_ANTIALIAS_MODE_PER_PRIMITIVE,
                                                 D2D1::IdentityMatrix(), 0.5f, nullptr, D2D1_LAYER_OPTIONS_NONE),
                           pLayer);
  ...
  // Draw nodes
  visitor::NodeDrawVisitor nodeDrawVisitor(pContext, pRenderTarget, m_pNodeViewManager, edittingNode);
