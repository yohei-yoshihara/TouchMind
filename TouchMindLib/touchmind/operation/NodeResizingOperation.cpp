...
void touchmind::operation::NodeResizingOperation::CreateDeviceDependentResources(touchmind::Context *pContext,
...
void touchmind::operation::NodeResizingOperation::Draw(touchmind::Context *pContext, ID2D1RenderTarget *pRenderTarget) {
  ...
  D2D1_RECT_F _rect = D2D1::RectF(rect.left - insets.left, rect.top - insets.top, rect.right + insets.right,
