...
STDMETHODIMP touchmind::control::DWriteEditControlTextStoreACP::QueryInsert(LONG acpTestStart, LONG acpTestEnd,
...
STDMETHODIMP touchmind::control::DWriteEditControlTextStoreACP::GetFormattedText(LONG acpStart, LONG acpEnd,
...
STDMETHODIMP touchmind::control::DWriteEditControlTextStoreACP::GetEmbedded(LONG acpPos, REFGUID rguidService,
...
STDMETHODIMP touchmind::control::DWriteEditControlTextStoreACP::QueryInsertEmbedded(const GUID *pguidService,
...
STDMETHODIMP touchmind::control::DWriteEditControlTextStoreACP::InsertEmbedded(DWORD dwFlags, LONG acpStart,
...
STDMETHODIMP touchmind::control::DWriteEditControlTextStoreACP::RequestSupportedAttrs(DWORD dwFlags, ULONG cFilterAttrs,
...
STDMETHODIMP touchmind::control::DWriteEditControlTextStoreACP::RequestAttrsAtPosition(LONG acpPos, ULONG cFilterAttrs,
                                                                                       const TS_ATTRID *paFilterAttrs,
                                                                                       DWORD dwFlags) {
  UNREFERENCED_PARAMETER(acpPos);
...
STDMETHODIMP touchmind::control::DWriteEditControlTextStoreACP::GetACPFromPoint(TsViewCookie vcView, const POINT *pt,
...
STDMETHODIMP touchmind::control::DWriteEditControlTextStoreACP::InsertEmbeddedAtSelection(
...
STDMETHODIMP touchmind::control::DWriteEditControlTextStoreACP::_TestInsert(LONG acpTestStart, LONG acpTestEnd,
                                                                            ULONG cch, LONG *pacpResultStart,
                                                                            LONG *pacpResultEnd) {
...
STDMETHODIMP touchmind::control::DWriteEditControlTextStoreACP::OnStartComposition(ITfCompositionView *pComposition,
                                                                                   BOOL *pfOk) {
...
STDMETHODIMP touchmind::control::DWriteEditControlTextStoreACP::OnUpdateComposition(ITfCompositionView *pComposition,
                                                                                    ITfRange *pRangeNew) {
  UNREFERENCED_PARAMETER(pComposition);
...
HRESULT touchmind::control::DWriteEditControlTextStoreACP::ChangeACPWithoutLock(LONG acpStart, LONG acpEnd,
...
void touchmind::control::DWriteEditControlTextStoreACP::_Internal_ReplaceText(LONG startPos, LONG length,
                                                                              std::wstring &s) {
  LONG oldLength = static_cast<LONG>(m_text.length());
