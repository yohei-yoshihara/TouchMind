...
public:
    ...
    HRESULT CreateEditControl(IN D2D1_RECT_F layoutRect, IN const std::wstring& text, OUT EDIT_CONTROL_INDEX *editControlIndex);
    ...
    void ShowSelection();
    static void GetFontInfoFromIPropertyStore(IN IPropertyStore* pPropertyStore, OUT touchmind::text::FontAttributeCommand* pFontInfo);
    static void GetIPropertyStoreFromFontInfo(IN touchmind::text::FontAttributeCommand* pFontInfo, OUT IPropertyStore* pPropertyStore);
