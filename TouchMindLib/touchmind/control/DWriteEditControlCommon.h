...
typedef std::map<EDIT_CONTROL_INDEX, std::shared_ptr<control::DWriteEditControl>> EditControlIndexToEditControlPtrMap;
typedef std::pair<EDIT_CONTROL_INDEX, std::shared_ptr<control::DWriteEditControl>> EditControlIndexToEditControlPtrPair;
