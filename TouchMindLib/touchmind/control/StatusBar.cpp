...
HRESULT touchmind::control::StatusBar::Initialize(HWND hwndParent, int idStatus, HINSTANCE hInstance,
                                                  int numberOfParts) {
  HRESULT hr;
  ...
  m_hWnd = CreateWindowEx(0, STATUSCLASSNAME, nullptr, SBARS_SIZEGRIP | WS_CHILD | WS_VISIBLE, 0, 0, 0, 0, hwndParent,
