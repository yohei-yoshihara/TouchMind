...
{
    strm << L"Configuration[Insets=" << val.GetInsets()
         << L",levelSeparation=" << val.GetLevelSeparation()
         << L",siblingSeparation=" << val.GetSiblingSeparation()
         << L",subtreeSeparation=" << val.GetSubtreeSeparation()
         << L",maxDepth=" << val.GetMaxDepth()
         << L",lineScrollDistance=" << val.GetLineScrollDistance()
         << L",pageScrollDistance=" << val.GetPageScrollDistance()
         << L",maxUndoCount=" << val.GetMaxUndoCount()
         << L",defaultFontFamilyName=" << val.GetDefaultFontFamilyName()
         << L",defaultLocaleName=" << val.GetDefaultLocaleName()
         << L",defaultFontSize=" << val.GetDefaultFontSize()
         << L",hitTestMargin=" << val.GetHitTestMargin()
         << L"]";
    return strm;
}
