...
void touchmind::text::FontAttributeCommand::FromFontAttribute(touchmind::Configuration* pConfiguration, touchmind::text::FontAttribute* pFontAttribute)
{
    // font family name
...
std::wostream& operator<< (std::wostream& os, touchmind::text::FontAttributeCommand const& fontAttributeCommand)
{
    ...
    if (fontAttributeCommand.foregroundColorStatus != UI_FONTPROPERTIES_NOTAVAILABLE) {
        os << L",foregroundColor=(" << fontAttributeCommand.foregroundColor.r << L"," << fontAttributeCommand.foregroundColor.g << L","
           << fontAttributeCommand.foregroundColor.b << L"," << fontAttributeCommand.foregroundColor.a << L")";
    }
    os << L"]";
    return os;
}
