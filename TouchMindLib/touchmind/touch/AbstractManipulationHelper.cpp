...
touchmind::touch::AbstractManipulationHelper::OnLeftMouseDown(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
...
touchmind::touch::ManipulationResult
touchmind::touch::AbstractManipulationHelper::OnMouseMove(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
  UNREFERENCED_PARAMETER(message);
...
touchmind::touch::ManipulationResult
touchmind::touch::AbstractManipulationHelper::OnLeftMouseDoubleClick(HWND hWnd, UINT message, WPARAM wParam,
                                                                     LPARAM lParam) {
  UNREFERENCED_PARAMETER(message);
...
touchmind::touch::ManipulationResult
touchmind::touch::AbstractManipulationHelper::OnLeftMouseUp(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
  UNREFERENCED_PARAMETER(message);
...
touchmind::touch::ManipulationResult
touchmind::touch::AbstractManipulationHelper::OnTimer(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
  UNREFERENCED_PARAMETER(message);
...
touchmind::touch::ManipulationResult
touchmind::touch::AbstractManipulationHelper::OnTouch(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
...
touchmind::touch::ManipulationResult
touchmind::touch::AbstractManipulationHelper::OnRightMouseDown(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
  UNREFERENCED_PARAMETER(message);
...
touchmind::touch::ManipulationResult
touchmind::touch::AbstractManipulationHelper::OnGesture(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
  UNREFERENCED_PARAMETER(message);
  ManipulationResult result;
  ULONGLONG currentTimestampInMilliSeconds = GetCurrentTimestampInMilliSeconds();
  GESTUREINFO gi = {0};
...
touchmind::touch::ManipulationResult
touchmind::touch::AbstractManipulationHelper::OnSetCursor(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
  UNREFERENCED_PARAMETER(hWnd);
  UNREFERENCED_PARAMETER(message);
  UNREFERENCED_PARAMETER(wParam);
  UNREFERENCED_PARAMETER(lParam);
