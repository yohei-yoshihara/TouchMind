...
HRESULT touchmind::util::BitmapHelper::CreateBitmap(
    IN IWICImagingFactory *pWICFactory, IN UINT width, IN UINT height, OUT IWICBitmap **ppWICBitmap )
{
    HRESULT hr = S_OK;
...
HRESULT touchmind::util::BitmapHelper::CreateBitmapRenderTarget( IN IWICBitmap *pWICBitmap, IN ID2D1Factory *pD2DFactory, OUT ID2D1RenderTarget **ppRenderTarget )
{
    HRESULT hr = S_OK;

    hr = pD2DFactory->CreateWicBitmapRenderTarget(pWICBitmap,
...
HRESULT touchmind::util::BitmapHelper::CreateBitmapFromWICBitmapSource( IN IWICBitmapSource *pBitmapSource, OUT HBITMAP *pHBitmap )
{
    HRESULT hr = S_OK;
...
HRESULT touchmind::util::BitmapHelper::CreateBitmapFromHBITMAP(IN IWICImagingFactory *pWICFactory, IN HBITMAP hBitmap, OUT IWICBitmap **ppWICBitmap )
{
