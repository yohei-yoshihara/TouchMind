...
COMDLG_FILTERSPEC touchmind::win::TouchMindApp::DIALOG_FILTERS[] = {
    { _OPEN_DIALOG_BOX_LONG, _OPEN_DIALOG_BOX_SHORT },
    { L"All types(*.*)", L"*.*" }
};
...
void touchmind::win::TouchMindApp::Initialize()
{
    ...
    if (hAccel == nullptr) {
        DWORD lastError = GetLastError();
        LOG(SEVERITY_LEVEL_ERROR) << util::LastError(util::LastErrorArgs(L"LoadAccelerators(IDR_ACCELERATOR_DEFAULT)", lastError));
    ...
    m_hwnd = CreateWindow(L"TouchMindApp",
                          _WINDOW_TITLE,
...
void touchmind::win::TouchMindApp::_InitializeRibbon()
{
    ...
    m_ribbonRequestDispatcher->AddInvalidateCallback([this]() {
    ...
    CComPtr<IUICommandHandler> nodeShapeCommandHandler(new touchmind::ribbon::handler::NodeShapeCommandHandler(
                m_pRibbonFramework.get(),
                m_ribbonRequestDispatcher.get()));
    ...
    m_ribbonRequestDispatcher->AddSelectionChangedListner([](touchmind::ribbon::RibbonFramework * pRibbonFramework,
    ...
    std::shared_ptr<touchmind::selection::SelectableSupport> newSelectedItem) {
        ...
        pRibbonFramework->GetFramework()->InvalidateUICommand(cmdNodeShape, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_SelectedItem);
    ...
    CComPtr<IUICommandHandler> nodeBackgroundCommandHandler(new touchmind::ribbon::handler::NodeBackgroundColorCommandHandler(
                m_pCanvasPanel->GetContext(),
                m_pRibbonFramework.get(),
                m_ribbonRequestDispatcher.get()));
    ...
    m_ribbonRequestDispatcher->AddSelectionChangedListner([](touchmind::ribbon::RibbonFramework * pRibbonFramework,
            std::shared_ptr<touchmind::selection::SelectableSupport> oldSelectedItem,
    std::shared_ptr<touchmind::selection::SelectableSupport> newSelectedItem) {
        pRibbonFramework->GetFramework()->InvalidateUICommand(cmdBackgroundColor, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_Enabled);
        pRibbonFramework->GetFramework()->InvalidateUICommand(cmdBackgroundColor, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_ColorType);
        pRibbonFramework->GetFramework()->InvalidateUICommand(cmdBackgroundColor, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_Color);
        pRibbonFramework->GetFramework()->InvalidateUICommand(cmdBackgroundColor, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_LargeImage);
    });
    ...
    std::shared_ptr<touchmind::selection::SelectableSupport> newSelectedItem) {
        ...
        pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineWidth, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_SelectedItem);
    ...
    std::shared_ptr<touchmind::selection::SelectableSupport> newSelectedItem) {
        ...
        pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineStyle, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_SelectedItem);
    ...
    m_ribbonRequestDispatcher->AddSelectionChangedListner([](touchmind::ribbon::RibbonFramework * pRibbonFramework,
            std::shared_ptr<touchmind::selection::SelectableSupport> oldSelectedItem,
    std::shared_ptr<touchmind::selection::SelectableSupport> newSelectedItem) {
        pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineEdgeStyle, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_Enabled);
        pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineEdgeStyle, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_SelectedItem);
        pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineEdgeStyle, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_LargeImage);
    });
    ...
    cmdMRUList, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY * key, const PROPVARIANT * pPropvarValue, IUISimplePropertySet*)->HRESULT {
    ...
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdNew, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnNew();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdOpenFreeMind, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnOpenFreeMind();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdOpenFile, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnOpenFile();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdSave, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnSave();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdSaveAs, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnSaveAs();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdCreateChildNode, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnCreateChildNode();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdEditNode, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnEditNode();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdDeleteNode, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnEditDelete();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdExit, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnExit();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdCopy, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnEditCopy();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdPaste, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnEditPaste();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdCut, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnEditCut();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdUndo, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnEditUndo();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdDeleteLink, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnDeleteLink();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdExpandNodes, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnExpandNodes();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdCollapseNodes, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnCollapseNodes();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdVersionInfo, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        DialogBox(
            MUI::GetHModule(),
            MAKEINTRESOURCE(IDD_VERSION_DIALOG),
            m_pRibbonFramework->GetHWnd(),
            DialogProc);
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdPrint, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnPrint();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdPrintSetup, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnPrintSetup();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnExecuteListener(
    cmdCreateLink, [this](UINT, UI_EXECUTIONVERB, const PROPERTYKEY*, const PROPVARIANT*, IUISimplePropertySet*)->HRESULT {
        OnCreateLink();
        return S_OK;
    });
    m_pRibbonFramework->GetRibbonCommandHandler()->AddOnUpdatePropertyListener(
    cmdCreateLink, [this](UINT nCmdID, REFPROPERTYKEY key, const PROPVARIANT * pPropvarCurrentValue, PROPVARIANT * pPropvarNewValue)->HRESULT {
...
void touchmind::win::TouchMindApp::_InitializeShellLibrary()
{
    ...
    if (touchmind::util::OSVersionChecker::IsWin7()) {
        ...
        if (FAILED(hr)) {
            DWORD lastError = GetLastError();
            LOG(SEVERITY_LEVEL_ERROR) << util::LastError(util::LastErrorArgs(L"SetCurrentProcessExplicitAppUserModelID", lastError));
            return;
        }
    }
...
void touchmind::win::TouchMindApp::OnCreate(
    HWND hwnd,
    UINT message,
    WPARAM wParam,
    LPARAM lParam)
...
LRESULT CALLBACK touchmind::win::TouchMindApp::WndProc(
    HWND hwnd,
    UINT message,
    WPARAM wParam,
    LPARAM lParam)
{
    ...
    if (message == WM_CREATE) {
        ...
        touchmind::win::TouchMindApp *pTouchMindApp =
            reinterpret_cast<touchmind::win::TouchMindApp*>(
        ...
        if (pTouchMindApp) {
            ...
            case WM_ACTIVATE:
                ...
                // do SetFocus
            case WM_SETFOCUS:
                if (pTouchMindApp->m_pCanvasPanel != nullptr
                        && pTouchMindApp->m_pCanvasPanel->IsInitialized()) {
            ...
            case WM_SIZE: {
                ...
                if (pTouchMindApp->m_pStatusBar != nullptr
                        && pTouchMindApp->m_pStatusBar->IsInitialized()) {
...
void touchmind::win::TouchMindApp::OnCreateChildNode()
{
    ...
    std::shared_ptr<touchmind::model::node::NodeModel> newChildNode = touchmind::model::node::NodeModel::Create(
                m_pCanvasPanel->GetSelectionManager());
...
void touchmind::win::TouchMindApp::_OnOpenFile(const std::wstring & fileName)
{
    if (PathFileExistsW(fileName.c_str())) {
        ...
        MessageBox(m_hwnd, buf, touchmind::MUI::GetString(IDS_OPEN_ERROR_CAPTION), MB_OK | MB_ICONERROR | MB_SETFOREGROUND | MB_TOPMOST);
    }
    ClearStatusBarText();
}
...
void touchmind::win::TouchMindApp::OnOpenFileByExtension(const std::wstring & fileName)
{
    CheckRequiredSave();
    std::wregex rx(L".*\\.mm");
    if (std::regex_match(std::begin(fileName), std::end(fileName), rx)) {
...
HRESULT touchmind::win::TouchMindApp::GetSelectedItem(
...
bool touchmind::win::TouchMindApp::OnClose()
{
    ...
    if (root->IsDescendantSaveRequired(m_fileOperation->GetSaveCounter())) {
        int ret = MessageBox(
                      m_hwnd,
                      touchmind::MUI::GetString(IDS_QUERY_SAVE_MESSAGE),
...
void touchmind::win::TouchMindApp::OnSaveAs()
{
    ...
    if (SUCCEEDED(hr)) {
        ...
        bool ret = std::regex_match(std::begin(fileName), std::end(fileName), rx);
        if (!ret) {
            fileName += _EXTENSION;
        }
        _OnSaveAs(fileName);
