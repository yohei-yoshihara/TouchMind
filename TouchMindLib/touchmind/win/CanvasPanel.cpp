...
touchmind::win::CanvasPanel::CanvasPanel(void) :
    ...
    m_pMapModel(new touchmind::model::MapModel()),
    m_pContext(new touchmind::Context()),
    m_pNodeViewManager(new touchmind::view::node::NodeViewManager),
    m_pLinkViewManager(new touchmind::view::link::LinkViewManager()),
    m_pLayoutManager(new touchmind::layout::LayoutManager),
    m_pDWriteTextSizeProvider(new touchmind::control::DWriteTextSizeProvider),
    m_pScrollBarHelper(new touchmind::util::ScrollBarHelper),
    m_pManipulationHelper(new touchmind::touch::ManipulationHelper),
    m_pEditControlManager(new touchmind::control::DWriteEditControlManager()),
    m_pClipboard(new touchmind::shell::Clipboard()),
    m_pPrintSetupDialog(new touchmind::print::XPSPrintSetupDialog()),
    m_pXPSPrint(new touchmind::print::XPSPrint()),
    m_createLinkOperation(new touchmind::operation::CreateLinkOperation()),
    m_nodeMovingOperation(new touchmind::operation::NodeMovingOperation()),
    m_nodeResizingOperation(new touchmind::operation::NodeResizingOperation()),
    m_selectionManager(new touchmind::selection::SelectionManager()),
    m_nodeModelXMLEncoder(new touchmind::converter::NodeModelXMLEncoder()),
    m_nodeModelXMLDecoder(new touchmind::converter::NodeModelXMLDecoder()),
    m_pEdittingNode()
{
