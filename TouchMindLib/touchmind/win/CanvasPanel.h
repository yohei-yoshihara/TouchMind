...
namespace touchmind {
  namespace win {
    ...
    class CanvasPanel : public touchmind::IRenderEventListener,
    ...
    private:
      ...
      std::shared_ptr<touchmind::model::node::NodeModel>
          m_pEdittingNode; // must be synchronized with focused edit control
    ...
    public:
      ...
      void CreateCurvePathGeometry(touchmind::model::CurvePoints *pCurvePoints, ID2D1Factory *pDirect2DFactory,
      ...
      virtual HRESULT CreateDeviceIndependentResources(touchmind::Context *, ID2D1Factory *, IWICImagingFactory *,
                                                       IDWriteFactory *) override {
        return S_OK;
      }
      virtual HRESULT CreateD3DResources(touchmind::Context *, ID3D10Device *) override {
        return S_OK;
      };
      virtual HRESULT CreateD2DResources(touchmind::Context *pContext, ID2D1Factory *pD2DFactory,
      ...
      virtual HRESULT PrepareRender3D(touchmind::Context *, ID3D10Device *) override {
        return S_OK;
      }
      virtual HRESULT Render3D(touchmind::Context *, ID3D10Device *) override {
        return S_OK;
      }
      virtual HRESULT AfterRender3D(touchmind::Context *, ID2D1RenderTarget *) override {
        return S_OK;
      }
