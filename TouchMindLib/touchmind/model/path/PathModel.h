...
class PathModel :
    public touchmind::model::BaseModel,
...
public:
    ...
    bool operator==(const PathModel &other) const {
        if (!m_node.expired() && !other.m_node.expired()) {
            return m_node.lock() == other.m_node.lock() &&
                   m_lineColor.r == other.m_lineColor.r &&
                   m_lineColor.g == other.m_lineColor.g &&
                   m_lineColor.b == other.m_lineColor.b &&
                   m_lineColor.a == other.m_lineColor.a &&
                   m_lineWidth == other.m_lineWidth &&
                   m_lineStyle == other.m_lineStyle;
        } else if (m_node.expired() && other.m_node.expired()) {
            return m_lineColor.r == other.m_lineColor.r &&
                   m_lineColor.g == other.m_lineColor.g &&
                   m_lineColor.b == other.m_lineColor.b &&
                   m_lineColor.a == other.m_lineColor.a &&
                   m_lineWidth == other.m_lineWidth &&
    ...
    void SetColor(D2D1_COLOR_F color) {
        if (m_lineColor.r == color.r &&
                m_lineColor.g == color.g &&
                m_lineColor.b == color.b &&
