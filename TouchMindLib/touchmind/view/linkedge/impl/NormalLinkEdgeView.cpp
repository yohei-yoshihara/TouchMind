...
void touchmind::view::linkedge::impl::NormalLinkEdgeView::Draw(touchmind::Context *pContext,
...
void touchmind::view::linkedge::impl::NormalLinkEdgeView::Fill(touchmind::Context *pContext,
                                                               ID2D1RenderTarget *pRenderTarget, ID2D1Brush *pBrush) {
  UNREFERENCED_PARAMETER(pContext);
  UNREFERENCED_PARAMETER(pRenderTarget);
  UNREFERENCED_PARAMETER(pBrush);
...
bool touchmind::view::linkedge::impl::NormalLinkEdgeView::HitTest(touchmind::Context *pContext,
