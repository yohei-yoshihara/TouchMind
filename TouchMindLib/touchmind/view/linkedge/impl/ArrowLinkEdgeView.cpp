    ...
    ID2D1RenderTarget *pRenderTarget)
{
    ...
    if (linkEdge->IsRepaintRequired(GetRepaintCounter()) ||
        ...
        CHK_RES(m_pArrowGeometry,
                view::GeometryBuilder::CreatePathGeometryFromPoints(
                    pD2DFactory,
                    points,
                    &m_pArrowGeometry));
...
void touchmind::view::linkedge::impl::ArrowLinkEdgeView::Draw(
    touchmind::Context *pContext,
    ID2D1RenderTarget *pRenderTarget,
    ID2D1Brush *pBrush,
    FLOAT width)
...
void touchmind::view::linkedge::impl::ArrowLinkEdgeView::Fill(
    touchmind::Context *pContext,
    ID2D1RenderTarget *pRenderTarget,
    ID2D1Brush *pBrush)
{
...
bool touchmind::view::linkedge::impl::ArrowLinkEdgeView::HitTest(
    touchmind::Context *pContext,
    ID2D1RenderTarget *pRenderTarget,
    D2D1_POINT_2F point)
{
