#ifndef TOUCHMIND_VIEW_LINKEDGE_IMPL_CIRCLELINKEDGEVIEW_H_
#define TOUCHMIND_VIEW_LINKEDGE_IMPL_CIRCLELINKEDGEVIEW_H_
  ...
  namespace view {
    namespace linkedge {
      namespace impl {
        ...
        class CircleLinkEdgeView : public touchmind::view::linkedge::BaseLinkEdgeView,
                                   public std::enable_shared_from_this<CircleLinkEdgeView> {
        private:
          CComPtr<ID2D1EllipseGeometry> m_pCircleGeometry;
          CComPtr<ID2D1SolidColorBrush> m_pBrush;

        public:
          CircleLinkEdgeView(std::weak_ptr<touchmind::model::link::LinkModel> link, EDGE_ID edgeId);
          virtual ~CircleLinkEdgeView();
...
#endif // TOUCHMIND_VIEW_LINKEDGE_IMPL_CIRCLELINKEDGEVIEW_H_