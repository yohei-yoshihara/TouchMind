...
void touchmind::view::linkedge::impl::CircleLinkEdgeView::CreateDeviceDependentResources(
  ...
  if (linkEdge->IsRepaintRequired(GetRepaintCounter()) || m_pCircleGeometry == nullptr || m_pBrush == nullptr) {
...
void touchmind::view::linkedge::impl::CircleLinkEdgeView::Draw(touchmind::Context *pContext,
...
void touchmind::view::linkedge::impl::CircleLinkEdgeView::Fill(touchmind::Context *pContext,
                                                               ID2D1RenderTarget *pRenderTarget, ID2D1Brush *pBrush) {
  CreateDeviceDependentResources(pContext, pRenderTarget);
  pRenderTarget->FillGeometry(m_pCircleGeometry, pBrush == nullptr ? m_pBrush : pBrush);
}

bool touchmind::view::linkedge::impl::CircleLinkEdgeView::HitTest(touchmind::Context *pContext,
