...
std::shared_ptr<touchmind::view::linkedge::BaseLinkEdgeView>
touchmind::view::linkedge::LinkEdgeViewFactory::Create(std::shared_ptr<touchmind::model::link::LinkModel> link,
                                                       EDGE_ID edgeId) {
