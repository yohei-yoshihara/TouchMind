  ...
  namespace view {
    namespace path {
      namespace impl {
        ...
        class DefaultPathView : public touchmind::view::path::BasePathView {
        private:
        ...
        protected:
          bool _CheckValidity();
          void _CreateDeviceDependentResources(touchmind::Context *pContext, ID2D1RenderTarget *pRenderTarget,
                                               std::shared_ptr<touchmind::model::node::NodeModel> node);
          void _CreateTexture(touchmind::Context *pContext, ID2D1RenderTarget *pRenderTarget,
                              std::shared_ptr<touchmind::model::node::NodeModel> node);
