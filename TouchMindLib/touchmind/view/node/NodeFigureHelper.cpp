...
touchmind::view::node::NodeFigureHelper::NodeFigureHelper(void)
    ...
    , m_strokeColor(D2D1::ColorF(0.3f, 0.3f, 0.3f, 1.0f))
    , m_plateStartColor(D2D1::ColorF(0xffffff, 1.0f))
    , m_plateEndColor(D2D1::ColorF(0xcbcbcb, 1.0f))
    , m_rect(D2D1::RectF())
...
void touchmind::view::node::NodeFigureHelper::SetPlateStartColor(const D2D1_COLOR_F &plateStartColor) {
...
void touchmind::view::node::NodeFigureHelper::SetPlateEndColor(const D2D1_COLOR_F &plateEndColor) {
