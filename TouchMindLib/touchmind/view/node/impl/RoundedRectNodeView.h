#ifndef TOUCHMIND_VIEW_NODE_ROUNDEDRECTNODEVIEW_H_
#define TOUCHMIND_VIEW_NODE_ROUNDEDRECTNODEVIEW_H_
  ...
  namespace view {
    namespace node {
      namespace impl {
        ...
        class RoundedRectNodeView : public touchmind::view::node::BaseNodeView,
                                    public std::enable_shared_from_this<RoundedRectNodeView> {
        private:
          CComPtr<ID3D10Texture2D> m_pTexture;

        public:
          RoundedRectNodeView(std::weak_ptr<touchmind::model::node::NodeModel> node);
          virtual ~RoundedRectNodeView();
...
#endif // TOUCHMIND_VIEW_NODE_ROUNDEDRECTNODEVIEW_H_