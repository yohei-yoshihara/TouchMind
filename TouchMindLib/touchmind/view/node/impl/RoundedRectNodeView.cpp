...
touchmind::view::node::impl::RoundedRectNodeView::RoundedRectNodeView(std::weak_ptr<touchmind::model::node::NodeModel> node) :
    BaseNodeView(node),
    m_pTexture(nullptr)
{
}
...
void touchmind::view::node::impl::RoundedRectNodeView::Draw(
    touchmind::Context *pContext,
    ID2D1RenderTarget *pRenderTarget)
{
    LOG_ENTER;
    ...
    if (m_pTexture == nullptr ||
        ...
        nodeFigure.DrawPlate(bodyRect, nodeFigure.GetCornerRoundSize(), pContext->GetD2DFactory(), pOutputTexture2DRenderTarget);
...
bool touchmind::view::node::impl::RoundedRectNodeView::HitTest(
    touchmind::Context *pContext,
    ID2D1RenderTarget *pRenderTarget,
    D2D1_POINT_2F point )
{
