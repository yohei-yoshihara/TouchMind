...
public:
    ...
    HRESULT CreateSharedDeviceResources(
        touchmind::Context *pContext,
        ID2D1RenderTarget* pRenderTarget);
    ...
    std::shared_ptr<touchmind::model::node::NodeModel> NodeHitTest(
        touchmind::Context *pContext,
        ID2D1RenderTarget *pRenderTarget,
        D2D1_POINT_2F point);
    std::shared_ptr<touchmind::model::path::PathModel> PathHitTest(
        touchmind::Context *pContext,
        ID2D1RenderTarget *pRenderTarget,
        D2D1_POINT_2F point);
