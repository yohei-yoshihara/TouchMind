...
namespace touchmind {
  namespace view {
    namespace link {
      ...
      class BaseLinkView : public touchmind::view::BaseView {
      private:
      ...
      public:
        ...
        void SetLinkEdgeView(EDGE_ID edgeId,
                             const std::shared_ptr<touchmind::view::linkedge::BaseLinkEdgeView> &linkEdgeView) {
