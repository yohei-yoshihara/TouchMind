...
void touchmind::view::GeometryBuilder::_CalculateCollapsedMarkSize(
...
HRESULT touchmind::view::GeometryBuilder::CreateCollapsedMarkGeometry(
...
HRESULT touchmind::view::GeometryBuilder::CreateRoundedRectangleGeometry(
    IN ID2D1Factory* pD2DFactory,
    IN const D2D1_RECT_F &rect,
    IN FLOAT r,
    IN bool isCollapsed,
    ...
    OUT ID2D1PathGeometry** ppPathGeometry)
{
    ...
    pSink->AddArc(D2D1::ArcSegment(
                      D2D1::Point2F(rect.left + r, rect.top),
                      D2D1::SizeF(r, r),
                      touchmind::PI / 2.0f,
    ...
    pSink->AddArc(D2D1::ArcSegment(
                      D2D1::Point2F(rect.right, rect.top + r),
                      D2D1::SizeF(r, r),
                      touchmind::PI / 2.0f,
                      D2D1_SWEEP_DIRECTION_CLOCKWISE,
                      D2D1_ARC_SIZE_SMALL));
...
HRESULT touchmind::view::GeometryBuilder::CreateHalfRoundedRectangleGeometry(
    IN ID2D1Factory* pD2DFactory,
    IN const D2D1_RECT_F &rect,
    IN FLOAT r,
    OUT ID2D1PathGeometry** ppPathGeometry)
...
HRESULT touchmind::view::GeometryBuilder::CreateIsoscelesTriangleGeometry(
    IN ID2D1Factory* pD2DFactory,
    IN const D2D1_RECT_F &rect,
...
HRESULT touchmind::view::GeometryBuilder::CreateTriangleMoverGeometry(
    IN ID2D1Factory* pD2DFactory,
    IN const D2D1_RECT_F &rect,
    IN TRIANGLE_VERTEX tirangleVertex,
    OUT ID2D1PathGeometry** ppPathGeometry)
...
void touchmind::view::GeometryBuilder::TransformRect(
...
void touchmind::view::GeometryBuilder::CalculatePath(
...
HRESULT touchmind::view::GeometryBuilder::CreateCurvePathGeometry(
    IN ID2D1Factory* pD2DFactory,
    ...
    OUT ID2D1PathGeometry** ppPathGeometry)
{
    ...
    pSink->BeginFigure(
        D2D1::Point2F(curvePoints.GetX(0), curvePoints.GetY(0)),
        D2D1_FIGURE_BEGIN_FILLED //D2D1_FIGURE_BEGIN_HOLLOW
    );
    pSink->AddBezier(
        D2D1::BezierSegment(
            D2D1::Point2F(curvePoints.GetX(1), curvePoints.GetY(1)),
...
HRESULT touchmind::view::GeometryBuilder::CreateRectangleGeometry(
    IN ID2D1Factory* pD2DFactory,
    IN const D2D1_RECT_F &rect,
    IN bool isCollapsed,
    IN bool isRightSideNode,
...
void touchmind::view::GeometryBuilder::CalculateLink(
    ...
    OUT touchmind::model::CurvePoints& curvePoints)
{
    ...
    D2D1_POINT_2F handle1 = edge1->CalculateHandlePosition(
                                link->GetEdgePoint(EDGE_ID_1),
                                node1->GetAncestorPosition());
    D2D1_POINT_2F handle2 = edge2->CalculateHandlePosition(
                                link->GetEdgePoint(EDGE_ID_2),
                                node2->GetAncestorPosition());
...
void touchmind::view::GeometryBuilder::CalculateArrowPoints(
...
HRESULT touchmind::view::GeometryBuilder::CreatePathGeometryFromPoints(
    IN ID2D1Factory* pD2DFactory,
