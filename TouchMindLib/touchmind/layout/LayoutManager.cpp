...
touchmind::layout::LayoutWorkData* touchmind::layout::LayoutManager::_GetLayoutWorkData(
...
void touchmind::layout::LayoutManager::SetLevelHeight(const std::shared_ptr<touchmind::model::node::NodeModel> &node, int level)
{
...
void touchmind::layout::LayoutManager::SetNeighbors(const std::shared_ptr<touchmind::model::node::NodeModel> &node, int level)
{
...
void touchmind::layout::LayoutManager::SaveAsVML( const std::wstring &filename )
{
    ...
    fout << L"<!-- (" << treeRectVisitor.treeRect.x1 << L"," << treeRectVisitor.treeRect.y1
         << L") - (" << treeRectVisitor.treeRect.x2 << L"," << treeRectVisitor.treeRect.y2 << L") -->" << std::endl;
    fout << L"<v:rect style=\"position:absolute;margin-top:0"
         << L";margin-left:0"
         << L";width:" << (treeRectVisitor.treeRect.x2 - treeRectVisitor.treeRect.x1)
         << L";height:" << (treeRectVisitor.treeRect.y2 - treeRectVisitor.treeRect.y1)
