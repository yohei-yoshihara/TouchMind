...
namespace touchmind {
  namespace layout {
    ...
    public:
      ...
      void FirstWalk(const std::shared_ptr<touchmind::model::node::NodeModel> &tree,
                     const std::shared_ptr<touchmind::model::node::NodeModel> &node, int level);
      void SecondWalk(const std::shared_ptr<touchmind::model::node::NodeModel> &tree,
                      const std::shared_ptr<touchmind::model::node::NodeModel> &node, int level, FLOAT x, FLOAT y);
      void Apportion(const std::shared_ptr<touchmind::model::node::NodeModel> &tree,
                     const std::shared_ptr<touchmind::model::node::NodeModel> &node, int level);
      void PositionTree();
      ...
      GetLeftMost(const std::shared_ptr<touchmind::model::node::NodeModel> &node, int level, int maxLevel) const;
