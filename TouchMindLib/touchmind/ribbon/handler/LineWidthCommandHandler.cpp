...
IFACEMETHODIMP touchmind::ribbon::handler::LineWidthCommandHandler::Execute(
    UINT cmdID,
    ...
    IUISimplePropertySet* pCommandExecutionProperties)
{
    ...
    if ( pKey && *pKey == UI_PKEY_SelectedItem) {
        ...
        m_pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineWidth, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_LargeImage);
    }
    return hr;
}
    ...
    PROPVARIANT* pPropvarNewValue)
{
    ...
    if (key == UI_PKEY_Enabled) {
        ...
        m_pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineWidth, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_SelectedItem);
        m_pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineWidth, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_LargeImage);
