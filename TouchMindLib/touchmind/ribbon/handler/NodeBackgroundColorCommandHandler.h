#ifndef TOUCHMIND_RIBBON_HANDLER_NODEBACKGROUNDCOLORCOMMANDHANDLER2_H_
#define TOUCHMIND_RIBBON_HANDLER_NODEBACKGROUNDCOLORCOMMANDHANDLER2_H_
...
namespace touchmind {
  namespace ribbon {
    namespace handler {
      ...
      class NodeBackgroundColorCommandHandler : public IUICommandHandler {
      private:
        ULONG m_refCount;
      ...
      public:
        ...
        NodeBackgroundColorCommandHandler();
        NodeBackgroundColorCommandHandler(
        ...
        virtual ~NodeBackgroundColorCommandHandler();
...
#endif // TOUCHMIND_RIBBON_HANDLER_NODEBACKGROUNDCOLORCOMMANDHANDLER2_H_