...
const std::array<int, NUMBER_OF_LINE_STYLES> touchmind::ribbon::handler::LineStyleCommandHandler::s_IMAGE_ID = {
    IDB_LINESTYLE_SOLID,
    IDB_LINESTYLE_DASHED,
    IDB_LINESTYLE_DOTTED,
};

const std::array<int, NUMBER_OF_LINE_STYLES> touchmind::ribbon::handler::LineStyleCommandHandler::s_IMAGE64x24_ID = {
    IDB_LINESTYLE_SOLID64x24,
    IDB_LINESTYLE_DASHED64x24,
    IDB_LINESTYLE_DOTTED64x24,
};
...
IFACEMETHODIMP touchmind::ribbon::handler::LineStyleCommandHandler::Execute(
    UINT cmdID,
    ...
    IUISimplePropertySet* pCommandExecutionProperties)
{
    ...
    if ( pKey && *pKey == UI_PKEY_SelectedItem) {
        ...
        m_pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineStyle, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_LargeImage);
    }
    return hr;
}
    ...
    PROPVARIANT* pPropvarNewValue)
{
    ...
    */
    ...
    if (key == UI_PKEY_Enabled) {
        ...
        m_pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineStyle, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_SelectedItem);
        m_pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineStyle, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_LargeImage);
