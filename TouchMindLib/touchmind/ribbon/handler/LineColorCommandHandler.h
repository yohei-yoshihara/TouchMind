...
namespace touchmind {
  namespace ribbon {
    namespace handler {
      ...
      class LineColorCommandHandler : public IUICommandHandler {
      private:
        ULONG m_refCount;
      ...
      public:
        ...
        LineColorCommandHandler(touchmind::Context *pContext, touchmind::ribbon::RibbonFramework *pRibbonFramework,
