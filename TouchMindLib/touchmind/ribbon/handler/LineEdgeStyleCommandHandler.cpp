...
const std::array<int, NUMBER_OF_LINE_EDGE_STYLES> touchmind::ribbon::handler::LineEdgeStyleCommandHandler::s_IMAGE_ID = {
    IDB_LINE_EDGE_STYLE_NORMAL,
    IDB_LINE_EDGE_STYLE_EDGE1_ARROW,
    IDB_LINE_EDGE_STYLE_EDGE2_ARROW,
    IDB_LINE_EDGE_STYLE_BOTH_ARROW,
    IDB_LINE_EDGE_STYLE_EDGE1_CIRCLE,
    IDB_LINE_EDGE_STYLE_EDGE2_CIRCLE,
    IDB_LINE_EDGE_STYLE_BOTH_CIRCLE,
    IDB_LINE_EDGE_STYLE_CIRCLE_ARROW,
    IDB_LINE_EDGE_STYLE_ARROW_CIRCLE,
};

const std::array<int, NUMBER_OF_LINE_EDGE_STYLES> touchmind::ribbon::handler::LineEdgeStyleCommandHandler::s_IMAGE36x36_ID = {
    IDB_LINE_EDGE_STYLE_NORMAL36x36,
    IDB_LINE_EDGE_STYLE_EDGE1_ARROW36x36,
    IDB_LINE_EDGE_STYLE_EDGE2_ARROW36x36,
    IDB_LINE_EDGE_STYLE_BOTH_ARROW36x36,
    IDB_LINE_EDGE_STYLE_EDGE1_CIRCLE36x36,
    IDB_LINE_EDGE_STYLE_EDGE2_CIRCLE36x36,
    IDB_LINE_EDGE_STYLE_BOTH_CIRCLE36x36,
    IDB_LINE_EDGE_STYLE_CIRCLE_ARROW36x36,
...
IFACEMETHODIMP touchmind::ribbon::handler::LineEdgeStyleCommandHandler::QueryInterface(REFIID riid, void** ppInterface)
{
    ...
    IUISimplePropertySet* pCommandExecutionProperties)
{
    ...
    if ( pKey && *pKey == UI_PKEY_SelectedItem) {
        ...
        m_pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineEdgeStyle, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_LargeImage);
    }
    return hr;
}
    ...
    PROPVARIANT* pPropvarNewValue)
{
    ...
    if (key == UI_PKEY_Enabled) {
        ...
        m_pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineEdgeStyle, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_SelectedItem);
        m_pRibbonFramework->GetFramework()->InvalidateUICommand(cmdLineEdgeStyle, UI_INVALIDATIONS_PROPERTY, &UI_PKEY_LargeImage);
...
touchmind::LINE_EDGE_STYLE touchmind::ribbon::handler::LineEdgeStyleCommandHandler::_ConvertToLineEdgeStyle( UINT32 index )
{
    const static LINE_EDGE_STYLE LINE_EDGE_STYLE_LIST[] = {
        LINE_EDGE_STYLE_NORMAL,
        LINE_EDGE_STYLE_EDGE1_ARROW,
        LINE_EDGE_STYLE_EDGE2_ARROW,
        LINE_EDGE_STYLE_BOTH_ARROW,
        LINE_EDGE_STYLE_EDGE1_CIRCLE,
        LINE_EDGE_STYLE_EDGE2_CIRCLE,
        LINE_EDGE_STYLE_BOTH_CIRCLE,
        LINE_EDGE_STYLE_CIRCLE_ARROW,
        LINE_EDGE_STYLE_ARROW_CIRCLE,
    };
