...
PaperInfo g_paperInfoList[] = {
    {touchmind::print::PRINTSETUP_PAGE_SIZE_A3, L"A3", {297.0f / 25.4f * 96.0f, 420.0f / 25.4f * 96.0f}},
    {touchmind::print::PRINTSETUP_PAGE_SIZE_A4, L"A4", {210.0f / 25.4f * 96.0f, 297.0f / 25.4f * 96.0f}},
    {touchmind::print::PRINTSETUP_PAGE_SIZE_A5, L"A5", {148.0f / 25.4f * 96.0f, 210.0f / 25.4f * 96.0f}},
    {touchmind::print::PRINTSETUP_PAGE_SIZE_B4, L"B4", {257.0f / 25.4f * 96.0f, 364.0f / 25.4f * 96.0f}},
    {touchmind::print::PRINTSETUP_PAGE_SIZE_B5, L"B5", {182.0f / 25.4f * 96.0f, 257.0f / 25.4f * 96.0f}},
    {touchmind::print::PRINTSETUP_PAGE_SIZE_LETTER, L"Letter 8.5x11", {8.5f * 96.0f, 11.0f * 96.0f}},
    {touchmind::print::PRINTSETUP_PAGE_SIZE_LEGAL, L"Legal 8.5x14", {8.5f * 96.0f, 14.0f * 96.0f}},
    {touchmind::print::PRINTSETUP_PAGE_SIZE_US4X8, L"US 4x8", {4.0f * 96.0f, 8.0f * 96.0f}},
    {touchmind::print::PRINTSETUP_PAGE_SIZE_US5X7, L"US 5x7", {5.0f * 96.0f, 7.0f * 96.0f}},
};
...
BOOL CALLBACK PrintSetupDialogProc(HWND hwndDlg, UINT message, WPARAM wParam, LPARAM lParam) {
...
bool touchmind::print::XPSPrintSetupDialog::Show() {
  ...
  bool ret = false;
  if (DialogBox(MUI::GetHModule(), MAKEINTRESOURCE(IDD_PRINT_SETTING), m_parentHWnd, (DLGPROC)PrintSetupDialogProc)
      == IDOK) {
    ret = true;
  } else {
    ret = false;
