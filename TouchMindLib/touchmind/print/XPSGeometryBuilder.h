...
public:
    static void CalculateTransformMatrix(
        ...
        OUT FLOAT &scale);
    static void CreateRoundedRectangleGeometry(
        IXpsOMObjectFactory *pXpsFactory,
        const XPS_RECT &rect,
        FLOAT r,
        OUT IXpsOMGeometryFigure **ppXpsFigure);
    static void CreateRectangleGeometry(
        IXpsOMObjectFactory *pXpsFactory,
        const XPS_RECT &rect,
        OUT IXpsOMGeometryFigure **ppXpsFigure);
    static void CreateCurvePathGeometry(
        IXpsOMObjectFactory *pXpsFactory,
        const touchmind::model::CurvePoints &curvePoints,
        OUT IXpsOMGeometryFigure **ppXpsFigure);
    static void CreatePathGeometryFromPoints(
        IXpsOMObjectFactory *pXpsFactory,
